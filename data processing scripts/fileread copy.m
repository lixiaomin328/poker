...
dataTable = readtable(filename, 'ReadRowNames', true); %data into table form
...
%dataTable = removevars(dataTable,{'trials_thisTrialN','trials_thisN', 'trials_thisIndex', 'participant', 'session', 'date', 'expName', 'psychopyVersion', 'frameRate', 'Var16'});
