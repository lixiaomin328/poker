...
% trialStart = find(contains(asc.msg,'P1 prechoose'));
% for trialNumber = 1:length(trialStart)
%     asc.msg{trialStart(trialNumber)} = ['MSG Trial ',num2str(trialNumber),' start'];
% end
